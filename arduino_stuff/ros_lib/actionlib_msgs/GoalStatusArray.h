...
public:
  ...
  GoalStatusArray() : header(), status_list_length(0), status_list(NULL)
  {
  }
  ...
  virtual int deserialize(unsigned char* inbuffer)
  {
    ...
    if (status_list_lengthT > status_list_length)
      this->status_list = (actionlib_msgs::GoalStatus*)realloc(
          this->status_list, status_list_lengthT * sizeof(actionlib_msgs::GoalStatus));
