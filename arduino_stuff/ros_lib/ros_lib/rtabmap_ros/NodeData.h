...
public:
  ...
  NodeData()
    ...
    , userData_length(0)
    , userData(NULL)
    , grid_ground_length(0)
    , grid_ground(NULL)
    , grid_obstacles_length(0)
    , grid_obstacles(NULL)
    , grid_cell_size(0)
    , grid_view_point()
    , wordIds_length(0)
  ...
  virtual int deserialize(unsigned char* inbuffer)
  {
    ...
    if (localTransform_lengthT > localTransform_length)
      this->localTransform = (geometry_msgs::Transform*)realloc(
          this->localTransform, localTransform_lengthT * sizeof(geometry_msgs::Transform));
    ...
    if (wordKpts_lengthT > wordKpts_length)
      this->wordKpts =
          (rtabmap_ros::KeyPoint*)realloc(this->wordKpts, wordKpts_lengthT * sizeof(rtabmap_ros::KeyPoint));
