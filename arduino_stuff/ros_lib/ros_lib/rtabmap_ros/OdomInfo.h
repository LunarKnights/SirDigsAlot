...
public:
  ...
  typedef float _varianceLin_type;
  _varianceLin_type varianceLin;
  typedef float _varianceAng_type;
  _varianceAng_type varianceAng;
  ...
  OdomInfo()
    ...
    , wordsKeys_length(0)
    , wordsKeys(NULL)
    , wordsValues_length(0)
    , wordsValues(NULL)
    , wordMatches_length(0)
    , wordMatches(NULL)
    , wordInliers_length(0)
    , wordInliers(NULL)
    , localMapKeys_length(0)
    , localMapKeys(NULL)
    , localMapValues_length(0)
    , localMapValues(NULL)
    , refCorners_length(0)
    , refCorners(NULL)
    , newCorners_length(0)
    , newCorners(NULL)
    , cornerInliers_length(0)
    , cornerInliers(NULL)
    , transform()
    , transformFiltered()
    , localScanMap_length(0)
    , localScanMap(NULL)
  {
  }
  ...
  virtual int serialize(unsigned char* outbuffer) const
  {
    ...
    *(outbuffer + offset + 3) = (u_inliers.base >> (8 * 3)) & 0xFF;
    ...
    u_varianceLin.real = this->varianceLin;
    *(outbuffer + offset + 0) = (u_varianceLin.base >> (8 * 0)) & 0xFF;
    *(outbuffer + offset + 1) = (u_varianceLin.base >> (8 * 1)) & 0xFF;
    *(outbuffer + offset + 2) = (u_varianceLin.base >> (8 * 2)) & 0xFF;
    *(outbuffer + offset + 3) = (u_varianceLin.base >> (8 * 3)) & 0xFF;
    offset += sizeof(this->varianceLin);
    union
    {
      float real;
      uint32_t base;
    } u_varianceAng;
    u_varianceAng.real = this->varianceAng;
    *(outbuffer + offset + 0) = (u_varianceAng.base >> (8 * 0)) & 0xFF;
    *(outbuffer + offset + 1) = (u_varianceAng.base >> (8 * 1)) & 0xFF;
    *(outbuffer + offset + 2) = (u_varianceAng.base >> (8 * 2)) & 0xFF;
    *(outbuffer + offset + 3) = (u_varianceAng.base >> (8 * 3)) & 0xFF;
    offset += sizeof(this->varianceAng);
    union
    {
      int32_t real;
      uint32_t base;
  ...
  virtual int deserialize(unsigned char* inbuffer)
  {
    ...
    u_varianceLin.base = 0;
    u_varianceLin.base |= ((uint32_t)(*(inbuffer + offset + 0))) << (8 * 0);
    u_varianceLin.base |= ((uint32_t)(*(inbuffer + offset + 1))) << (8 * 1);
    u_varianceLin.base |= ((uint32_t)(*(inbuffer + offset + 2))) << (8 * 2);
    u_varianceLin.base |= ((uint32_t)(*(inbuffer + offset + 3))) << (8 * 3);
    this->varianceLin = u_varianceLin.real;
    offset += sizeof(this->varianceLin);
    union
    {
      float real;
    ...
    u_varianceAng.base = 0;
    u_varianceAng.base |= ((uint32_t)(*(inbuffer + offset + 0))) << (8 * 0);
    u_varianceAng.base |= ((uint32_t)(*(inbuffer + offset + 1))) << (8 * 1);
    u_varianceAng.base |= ((uint32_t)(*(inbuffer + offset + 2))) << (8 * 2);
    u_varianceAng.base |= ((uint32_t)(*(inbuffer + offset + 3))) << (8 * 3);
    this->varianceAng = u_varianceAng.real;
    offset += sizeof(this->varianceAng);
    union
    {
      int32_t real;
    ...
    if (wordsValues_lengthT > wordsValues_length)
      this->wordsValues =
          (rtabmap_ros::KeyPoint*)realloc(this->wordsValues, wordsValues_lengthT * sizeof(rtabmap_ros::KeyPoint));
    ...
    if (localMapValues_lengthT > localMapValues_length)
      this->localMapValues =
          (rtabmap_ros::Point3f*)realloc(this->localMapValues, localMapValues_lengthT * sizeof(rtabmap_ros::Point3f));
    ...
    if (refCorners_lengthT > refCorners_length)
      this->refCorners =
          (rtabmap_ros::Point2f*)realloc(this->refCorners, refCorners_lengthT * sizeof(rtabmap_ros::Point2f));
    ...
    if (newCorners_lengthT > newCorners_length)
      this->newCorners =
          (rtabmap_ros::Point2f*)realloc(this->newCorners, newCorners_lengthT * sizeof(rtabmap_ros::Point2f));
  ...
  const char* getMD5()
  {
    return "e712c4aab4e90c60daa7b83e1fe4524c";
  };
};
}
#endif