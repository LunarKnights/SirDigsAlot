...
public:
  ...
  tfMessage() : transforms_length(0), transforms(NULL)
  {
  }
  ...
  virtual int deserialize(unsigned char* inbuffer)
  {
    ...
    if (transforms_lengthT > transforms_length)
      this->transforms = (geometry_msgs::TransformStamped*)realloc(
          this->transforms, transforms_lengthT * sizeof(geometry_msgs::TransformStamped));
