...
public:
  ...
  virtual int deserialize(unsigned char* inbuffer)
  {
    ...
    if (markers_lengthT > markers_length)
      this->markers = (visualization_msgs::InteractiveMarker*)realloc(
          this->markers, markers_lengthT * sizeof(visualization_msgs::InteractiveMarker));
    ...
    if (poses_lengthT > poses_length)
      this->poses = (visualization_msgs::InteractiveMarkerPose*)realloc(
          this->poses, poses_lengthT * sizeof(visualization_msgs::InteractiveMarkerPose));
