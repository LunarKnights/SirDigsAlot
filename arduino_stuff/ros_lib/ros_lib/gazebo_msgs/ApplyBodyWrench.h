...
public:
  ...
  ApplyBodyWrenchRequest() : body_name(""), reference_frame(""), reference_point(), wrench(), start_time(), duration()
  {
  }
...
public:
  ...
  ApplyBodyWrenchResponse() : success(0), status_message("")
  {
  }
