...
public:
  ...
  SetPhysicsPropertiesRequest() : time_step(0), max_update_rate(0), gravity(), ode_config()
  {
  }
...
public:
  ...
  SetPhysicsPropertiesResponse() : success(0), status_message("")
  {
  }
