...
public:
  ...
  SetJointTrajectoryRequest()
    : model_name(""), joint_trajectory(), model_pose(), set_model_pose(0), disable_physics_updates(0)
  {
  }
...
public:
  ...
  SetJointTrajectoryResponse() : success(0), status_message("")
  {
  }
