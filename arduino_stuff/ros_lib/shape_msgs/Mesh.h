...
public:
  ...
  Mesh() : triangles_length(0), triangles(NULL), vertices_length(0), vertices(NULL)
  {
  }
  ...
  virtual int deserialize(unsigned char* inbuffer)
  {
    ...
    if (triangles_lengthT > triangles_length)
      this->triangles =
          (shape_msgs::MeshTriangle*)realloc(this->triangles, triangles_lengthT * sizeof(shape_msgs::MeshTriangle));
