...
public:
  ...
  Group() : name(""), type(""), parameters_length(0), parameters(NULL), parent(0), id(0)
  {
  }
  ...
  virtual int deserialize(unsigned char* inbuffer)
  {
    ...
    if (parameters_lengthT > parameters_length)
      this->parameters = (dynamic_reconfigure::ParamDescription*)realloc(
          this->parameters, parameters_lengthT * sizeof(dynamic_reconfigure::ParamDescription));
