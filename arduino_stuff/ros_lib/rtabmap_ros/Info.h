...
public:
  ...
  Info()
    ...
    , posteriorKeys_length(0)
    , posteriorKeys(NULL)
    , posteriorValues_length(0)
    , posteriorValues(NULL)
    , likelihoodKeys_length(0)
    , likelihoodKeys(NULL)
    , likelihoodValues_length(0)
    , likelihoodValues(NULL)
    , rawLikelihoodKeys_length(0)
    , rawLikelihoodKeys(NULL)
    , rawLikelihoodValues_length(0)
    , rawLikelihoodValues(NULL)
    , weightsKeys_length(0)
    , weightsKeys(NULL)
    , weightsValues_length(0)
    , weightsValues(NULL)
    , statsKeys_length(0)
    , statsKeys(NULL)
    , statsValues_length(0)
    , statsValues(NULL)
    , localPath_length(0)
    , localPath(NULL)
    , currentGoalId(0)
  ...
  virtual int deserialize(unsigned char* inbuffer)
  {
    ...
    if (rawLikelihoodValues_lengthT > rawLikelihoodValues_length)
      this->rawLikelihoodValues =
          (float*)realloc(this->rawLikelihoodValues, rawLikelihoodValues_lengthT * sizeof(float));
